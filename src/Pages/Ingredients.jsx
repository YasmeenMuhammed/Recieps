        ...
        <div className="cards grid sm:grid-cols-12  gap-8">
          {ingredients && ingredients.map((ingredient) => <>
            ...
            <div className="meal-card  hover:shadow-xl sm:col-span-12 md:col-span-6 lg:col-span-3 bg-white items-center  rounded-4xl p-4 group hover:scale-105 transition-all duration-300 mt-12">
              <img src={ingredient.strThumb} className='meal-img bg-white size-45 rounded-full m-auto -translate-y-20 shadow-2xl drop-shadow-2xl group-hover:rotate-360 duration-700 transition-all ' alt="" />
