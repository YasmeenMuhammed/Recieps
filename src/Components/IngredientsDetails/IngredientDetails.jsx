...
export default function IngredientDetails() {
    ...
    if (!ingMeals) {
        return <>
                <div className="grid md:grid-cols-4 gap-10 pt-4">
                ...
                <div className="cards grid sm:grid-cols-12  gap-8">
                    {
                        ingMeals && ingMeals.map((ingMeal) => <>
                            <div className="sm:col-span-12 md:col-span-6 lg:col-span-3 bg-white items-center rounded-4xl p-4 mt-12">
                                <img src={ingMeal.strMealThumb} className='size-45 rounded-full m-auto -translate-y-20 shadow-2xl drop-shadow-2xl' alt="" />
