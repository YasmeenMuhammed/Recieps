...
export default function Card({ meal }) {
    ...
    return <>
        <div className="card active:scale-105 active:shadow-xl hover:bg-red-400  hover:shadow-xl sm:col-span-12 md:col-span-6 lg:col-span-3 bg-white items-center  rounded-4xl p-4 group hover:scale-105 transition-all duration-300 mt-12">
